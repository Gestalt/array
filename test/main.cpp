...
TEST(
    EraseIf, DeletesElementIfPredicateConditionAccomplished
  )
{
...
TEST(
    Sort, RearrangesArrayElementsInIncreasingOrder
  )
{
  arr::CArray<int> array;
  array.push_back(3);
...
TEST(
    CopyConstructor, MakesArrayCopy
  )
{
  arr::CArray<int> array;
  array.push_back(0);
...
TEST(
    AssignmentOperator, MakesArrayCopy
  )
{
...
TEST(
    Erase, ThrowsOnErasingOutOfRangeIndex
  )
{
  arr::CArray<int> array;
...
TEST(
    Erase, DeletesElementAtRequiredIndexPosition
  )
{
  arr::CArray<int> array;
  array.push_back(1);
...
TEST(
    Erase, ShiftsArrayElementsToLeftAfterDeletedElement
  )
{
  arr::CArray<int> array;
  array.push_back(0);
...
TEST(
    Insert, ThrowsOnInsertingOutOfRangeIndex
  )
{
  arr::CArray<int> array;
...
TEST(
    Insert, AddsElementAtRequiredIndexPosition
  )
{
  arr::CArray<int> array;
...
TEST(
    Insert, ShiftsArrayElementsToRightAfterInsertedElement
  )
{
  arr::CArray<int> array;
  array.push_back(0);
...
TEST(
    AccessOperator, ThrowsOnAccessingOutOfRangeIndex
  )
{
  arr::CArray<int> array;
  array.push_back(0);
...
TEST(
    AccessOperator, ReturnsArrayElementByIndex
  )
{
  arr::CArray<int> array;
...
TEST(
    AccessOperator, ThrowsOnAccessingEmptyArray
  )
{
  arr::CArray<int> array;
...
TEST(
    Array, IsNonEmptyWhenElementAdded
  )
{
  arr::CArray<int> array;
...
TEST(
    PushBack, InsertsElementAtArrayEnd
  )
{
  arr::CArray<int> array;
